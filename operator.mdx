...
This bundle deploys a GCP Cloud Function that is triggered via a HTTPS endpoint.
...
+ Authorization per-user not currently supported
+ This creates the infrastructure but you have to deploy to it
